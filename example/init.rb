module IRB
  ...
  module Extender
    ...
    def self.plugin(plugin, options = {})
      ...
      begin
        @context.instance_eval {puts "Requiring #{file}"; require file}
        puts "End of executing plugin"
      rescue LoadError => e
